...
// Active version (keeps your original code above as a commented reference)
using UnityEngine;
using UnityEngine.SceneManagement;
...
public class InteractLoadSceneT : MonoBehaviour
{
    [Header("Interaction")]
    [Tooltip("Scene name exactly as in Build Settings (case sensitive).")]
    public string sceneToLoad = "MemoryGame";
    ...
    private void Start()
    {
        // Ensure CoinManager exists early so coins always persist across scenes
